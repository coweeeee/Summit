...
export default function EditHikeScreen() {
  ...
  useEffect(() => {
    ...
    // `!= null`, not truthiness: a genuine 0 is a real elevation, and seeding
    // the field blank for it would make any unrelated edit — fixing a typo in
    // the notes — silently rewrite "flat" to "not recorded" on save.
    setElevationStr(hike.elevationFt != null ? String(Math.round(elevationFromFeet(hike.elevationFt, distanceUnit))) : "");
